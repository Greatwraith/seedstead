...
<body class="wrapper">
            ...
            <div class="slider-wrapper swiper-wrapper">
                <div class="slider-item swiper-slide">
                    <div class="slide-content">
                        ...
                        <a href="products.php" class="slide-button"><span>SEE PRODUCT</span></a>
                    </div>
                </div>
                <div class="slider-item swiper-slide">
                    <div class="slide-content">
    ...
    <div class="promo-right-box">
        ...
        <a href="products.php" class="btn promo-btn">See Products</a>
    </div>
</section>
    ...
    <!-- Footer -->
    <footer>
        <p>© 2025 SproutZilla | All Rights Reserved</p>
    </footer>
</body>
</html>